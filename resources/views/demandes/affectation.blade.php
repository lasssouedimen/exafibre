...
<main class="content">
    <div id="wrapper">
        ...
        <div class="content-wrapper">
                                ...
                                <table id="example" class="table table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($clientdemandes as $clientdemande)
                                            <tr>
                                                <td style="font-size:15px; ">{{ $clientdemande->nomfamille }}
                                                    {{ $clientdemande->prenom }}</td>
                                                ...
                                                <td> <button type="button" class="btn btn-light px-3 mr-2"
                                                        style="background-color: rgb(64, 33, 235) ; color :rgb(249, 249, 252); font-size:17 px; "
                                                        onclick="modaleaffectation('{{ $clientdemande->id }}')"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="currentColor" class="bi bi-indent"
                                                            viewBox="0 0 16 16">
            ...
            <div class="modal fade" id="affecter" tabindex="-1" role="dialog" aria-labelledby="addcltLabel"
                        ...
                        <form id="formaffecter" method="post" enctype="multipart/form-data" action="">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row mb-2">
                                    <label for="name" class="col-sm-4 col-form-label">liste
                                        Techniciens</label>
                            ...
                            <div class="modal-footer" style="background-color: rgb(249, 249, 252)">
                                <button type="submit" class="btn btn-success" id='myButton'
                                    style="background-color: rgb(83, 82, 86);width: 25%;
