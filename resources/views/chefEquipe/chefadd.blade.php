...
<main class="content">
    <div id="wrapper">
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">ChefD'equipe</h1><a class="badge bg-primary ms-2"></a>
        </div>
                        ...
                        <div class="card" style="background-color: rgba(255, 255, 255, 0.488);">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="card-header"><strong>Ajouter</strong><small> ChefD'equipe</title>
                                    </small></div>
                                    ...
                                    <form action="{{ route('chefEquipe.store') }}" method="POST"
                                        ...
                                        <div class="col-12 col-md-2"><input type="date" id="datenaissance"
