...
<title> Chef D'equipe | ExaFibre  </title>
<main class="content">
<div id="wrapper">
    <div class="mb-3">
        <h1 class="h3 d-inline align-middle">Chef D'equipe</h1><a class="badge bg-primary ms-2" ></a>
    </div>  
    ...
    <div class="content-wrapper">
                    ...
                    <div class="card" style="background-color: rgba(255, 255, 255, 0.488);">
                        ...
                        <div class="card-body">
                            <div class="form-group">
								<a href="{{ route('chefEquipe.index') }}" type="submit" class="btn btn-light px-2"
								...
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
								  ...
								  </svg></a>								<div class="card-header"><strong>Modifier</strong><small> Chef D'equipe</small></div>
		<div class="card-body card-block">
							...
							<hr>
                                ...
                                <form action="{{ route('chefEquipe.update', $chefequipe->id) }}" method="post"
						...
						<div class="row">
							 <div class="row form-group">
								...
								<div class="col-12 col-md-4"><input type="text" id="nom"
										name="nom" value="{{ $chefequipe->nom }}" class="form-control" required>
								</div>
								...
								<div class="col-12 col-md-4"><input type="text" id="prenom"
										name="prenom" value="{{ $chefequipe->prenom }}"  class="form-control" required>
								</div>
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-4"><input type="text" id="Adresse"
										name="Adresse" value="{{ $chefequipe->Adresse }}" class="form-control" required>
								</div>
								...
								<div class="col-12 col-md-4"><input type="number" id="Tel"
										name="Tel" value="{{ $chefequipe->Tel }}" class="form-control" required>
								</div>
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-4"><input type="date" id="Datedébut"
										name="Datedébut" value="{{ $chefequipe->Datedébut }}" class="form-control" required>
								</div>
								...
								<div class="col-12 col-md-4"><input type="mail" id="mail"
										name="mail" value="{{ $chefequipe->mail }}" class="form-control" required>
								</div>
						...
						<div class="col-12 col-md-2"><input type="number" id="Age"
								name="Age" value="{{ $chefequipe->Age }}"  class="form-control" required>
						</div>
